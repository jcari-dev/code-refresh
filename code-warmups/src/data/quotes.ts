...
export const QUOTES: Quote[] = [
  ...
  { text: "Good things are built slowly and last longer." },
  { text: "The effort fades. The growth stays." },
  { text: "Learning means you’re winning." },
  { text: "This chapter ends well." },
  ...
  { text: "Future you is doing just fine." },
  { text: "You’re not behind. You’re in progress." },
  { text: "This phase just looks dramatic from the inside." },
  { text: "You’re more capable than your inner narrator admits." },
  { text: "Things are aligning. Slowly. Calmly." },
  { text: "You’re doing real work, even when it feels quiet." },
  { text: "Your trajectory is better than it feels." },
  { text: "You’re allowed to take yourself seriously." },
  { text: "This is not the part where you give up." },
  { text: "You’ve survived every hard day so far." },
  { text: "You’re becoming someone you’ll be proud of." },
  { text: "Your success is currently unfolding." },
  { text: "You’re doing better than yesterday’s version of you." },
];
